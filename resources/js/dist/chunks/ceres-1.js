...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    labelHtml() {
      const contactPrivacyPolicy = this.$translate("Ceres::Template.contactPrivacyPolicy", {
        "hyphen": "&shy;"
      });
      const html = `
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    validateRegistration() {
      Object(_helper_executeReCaptcha__WEBPACK_IMPORTED_MODULE_2__["executeReCaptcha"])(this.$refs.registrationForm).then(recaptchaToken => {
        _services_ValidationService__WEBPACK_IMPORTED_MODULE_0__["default"].validate(this.$refs.registrationForm).done(() => {
          if (!this.enableConfirmingPrivacyPolicy || this.privacyPolicyAccepted) {
            ...
            _services_NotificationService__WEBPACK_IMPORTED_MODULE_7__["default"].error(this.$translate("Ceres::Template.contactAcceptFormPrivacyPolicy", {
              hyphen: "&shy;"
            }));
            this.resetRecaptcha();
          }
          ...
          if (invalidFieldNames.length > 0) {
            _services_NotificationService__WEBPACK_IMPORTED_MODULE_7__["default"].error(this.$translate("Ceres::Template.checkoutCheckAddressFormFields", {
    ...
    sendRegistration(recaptchaToken) {
      ...
      _services_ApiService__WEBPACK_IMPORTED_MODULE_6__["default"].post("/rest/io/customer", userObject).done(response => {
        ...
        if (!response.code) {
          ...
          _services_NotificationService__WEBPACK_IMPORTED_MODULE_7__["default"].success(this.$translate("Ceres::Template.regSuccessful")).closeAfter(3000);
          ...
          _services_NotificationService__WEBPACK_IMPORTED_MODULE_7__["default"].error(this.$translate("Ceres::Template.regError")).closeAfter(10000);
          this.resetRecaptcha();
        }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  watch: {
    currentSalutation(newVal, oldVal) {
      if (newVal !== oldVal) {
        const selectedSalutation = this.addressData.gender; // cleanse the current selected salutation, if it's not longer included in the choice
