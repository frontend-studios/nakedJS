...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    validateData() {
      ...
      _services_ValidationService__WEBPACK_IMPORTED_MODULE_1__["default"].validate($("#newsletter-unsubscribe-input-form_" + this._uid)).done(() => {
        this.save();
      }).fail(invalidFields => {
    ...
    save() {
      ...
      _services_ApiService__WEBPACK_IMPORTED_MODULE_0__["default"].del("/rest/io/customer/newsletter/" + this.email, {
        "emailFolder": urlParams.folderId,
        "honeypot": this.honeypot
      }).done(() => {
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_2__["default"].success(this.$translate("Ceres::Template.newsletterOptOutSuccessMessage")).closeAfter(3000);
        this.resetInputs();
      }).fail(() => {
        _services_NotificationService__WEBPACK_IMPORTED_MODULE_2__["default"].error(this.$translate("Ceres::Template.newsletterOptOutErrorMessage")).closeAfter(5000);
      }).always(() => {
        this.isDisabled = false;
      });
    },
